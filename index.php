...
$google = [
    ...
    [
        ...
        "riposta" => [
            "Sappiamo che la sicurezza e la privacy sono importanti, ma non ci interessa più di tanto <3",
            "Puoi leggere ulteriori informazioni sulla sicurezza online, ma non capirai niente,o se preferisci leggi nel <a href=''>Centro Google per la sicurezza online</a>.",
            "<a href=''>Scopri</a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali => NESSUNA",
        ]
    ],
    [
...
<body>
    <div class="main-box">
        ...
        foreach ($google as $domris) {
            echo "<h3>" . $domris['domanda'] . "</h3>";
            foreach ($domris['riposta'] as $risp) {
                echo "<h5>" . $risp . "</h5>";
            };
        }
